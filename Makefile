CC = gcc
CFLAGS = -O3 -Wall -g -static -DZLOG_ON -DDEBUG
DEMOCFLAGS = -O3 -Wall -g -DZLOG_ON -DDEBUG
LIBDIR =
...
CFLAGS_DLL = -Wall -O3 -g -static -Wl,--subsystem,windows,--out-implib,$(LIBDIR)/libzapengine.a -DZLOG_ON -DDEBUG
